...
TARGET_BOOTLOADER_BOARD_NAME := trltecan
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x02600000 --dt device/samsung/trltecan/dtb --tags_offset 0x02400000
...
#TARGET_PREBUILT_KERNEL := device/samsung/trltecan/kernAl
...
#BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/trltecan/custombootimg.mk
